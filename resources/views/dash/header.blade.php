<div class="header">
    <div class="header-left">
        <a href="#" class="logo"> <img src="{{asset('admin/img/hotel_logo.png')}}" width="50" height="70"
                alt="logo"> <span class="logoclass">HOTEL</span> </a>
        <a href="#" class="logo logo-small"> <img src="{{asset('admin/img/hotel_logo.png')}}" alt="Logo" width="30"
                height="30"> </a>
    </div>
    ...
    <ul class="nav user-menu">
                    ...
                    <ul class="notification-list">
                        ...
                        <li class="notification-message">
                            <a href="#">
                                <div class="media"> <span class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle" alt="User Image"
                                            src="{{asset('admin/img/profiles/avatar-11.jpg')}}">
                                    </span>
                                    <div class="media-body">
        ...
        <li class="nav-item dropdown has-arrow">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img
                        class="rounded-circle" src="{{asset('admin/img/profiles/avatar-01.jpg')}}" width="31"
                        alt="Soeng Souy"></span> </a>
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm"> <img src="{{asset('admin/img/profiles/avatar-01.jpg')}}" alt="User Image"
